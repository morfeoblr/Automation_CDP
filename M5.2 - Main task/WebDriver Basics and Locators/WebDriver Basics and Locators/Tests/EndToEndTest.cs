...
namespace WebDriver_Basics_and_Locators
{
    ...
    public class TestScenarios: BasePage
    {
        ...
        public void PlaceOrderWithLevel1Approvers()
        {
            ...
            startPage.OpenUrl();
            SelectAVendorPage selectAVendorPage = startPage.EnterCredentials(startPage);
            OldAdminPage oldAdminPage = selectAVendorPage.SelectTargetVendor(selectAVendorPage);
            HomePage homePage = oldAdminPage.LoginAsUser(oldAdminPage);
            SearchPage searchPage = homePage.Navigate_to_Search_page(homePage);
            ...
            CustomizationPage customizationPage = searchPage.ClickOnFirstReturnedItem(searchPage);
            ...
            ConfirmationPage confirmationPage = customizationPage.ClickPlaceOrderButton(customizationPage);
        ...
        public void HighLightAndClickSearchMenuviaJS()
        {
            ...
            SearchPage searchPage = homePage.JSClickOnSearch(homePage);
